...
#ifndef MDL_SOURCE_RELEASE
/// Check if the given semantics is from the nvidia::df module.
///
/// \param sema  the semantics
inline bool is_nvidia_df_semantics(IDefinition::Semantics sema)
{
    return
        IDefinition::DS_INTRINSIC_NVIDIA_DF_FIRST <= sema &&
        sema <= IDefinition::DS_INTRINSIC_NVIDIA_DF_LAST;
}
#endif
