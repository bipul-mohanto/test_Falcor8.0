    ...
    ICode_generator>
{
    ...
    /// The name of the option to generate code for use with the DF interpreter, if possible.
    #define MDL_JIT_OPTION_USE_DF_INTERPRETER "jit_use_df_interpreter"
#endif
...
#if !defined(MDL_SOURCE_RELEASE) && defined(MDL_ENABLE_INTERPRETER)
/*!
- \ref mdl_option_jit_use_df_interpreter         "jit_use_df_interpreter"
*/
#endif
/*!
...
#if !defined(MDL_SOURCE_RELEASE) && defined(MDL_ENABLE_INTERPRETER)
/*!
\anchor mdl_option_jit_use_df_interpreter
- <b>jit_use_df_interpreter</b>: If set to \c "true", the JIT will try to create code and data for
  the interpreter. If the requested DF is too complex, it will fall back to generating full code
  generation.
  Default: \c "false"
*/
#endif
...
/*!
\section mdl_glsl_code_generator_options Options for the MDL GLSL code generator

These options are specific to the MDL GLSL code generator:

- \ref mdl_option_glsl_enabled_extensions            "glsl_enabled_extensions"
- \ref mdl_option_glsl_include_uniform_state         "glsl_include_uniform_state"
- \ref mdl_option_glsl_lambda_enforce_vec3_return    "glsl_lambda_enforce_vec3_return"
- \ref mdl_option_glsl_max_const_data                "glsl_max_const_data"
- \ref mdl_option_glsl_place_uniforms_into_ssbo      "glsl_place_uniforms_into_ssbo"
- \ref mdl_option_glsl_profile                       "glsl_profile"
- \ref mdl_option_glsl_required_extensions           "glsl_required_extensions"
- \ref mdl_option_glsl_state_animation_time_mode     "glsl_state_animation_time_mode"
- \ref mdl_option_glsl_state_animation_time_name     "glsl_state_animation_time_name"
- \ref mdl_option_glsl_state_geometry_normal_mode    "glsl_state_geometry_normal_mode"
- \ref mdl_option_glsl_state_geometry_normal_name    "glsl_state_geometry_normal_name"
- \ref mdl_option_glsl_state_geometry_tangent_u_mode "glsl_state_geometry_tangent_u_mode"
- \ref mdl_option_glsl_state_geometry_tangent_u_name "glsl_state_geometry_tangent_u_name"
- \ref mdl_option_glsl_state_geometry_tangent_v_mode "glsl_state_geometry_tangent_v_mode"
- \ref mdl_option_glsl_state_geometry_tangent_v_name "glsl_state_geometry_tangent_v_name"
- \ref mdl_option_glsl_state_motion_mode             "glsl_state_motion_mode"
- \ref mdl_option_glsl_state_motion_name             "glsl_state_motion_name"
- \ref mdl_option_glsl_state_normal_mode             "glsl_state_normal_mode"
- \ref mdl_option_glsl_state_normal_name             "glsl_state_normal_name"
- \ref mdl_option_glsl_state_object_id_mode          "glsl_state_object_id_mode"
- \ref mdl_option_glsl_state_object_id_name          "glsl_state_object_id_name"
- \ref mdl_option_glsl_state_position_mode           "glsl_state_position_mode"
- \ref mdl_option_glsl_state_position_name           "glsl_state_position_name"
- \ref mdl_option_glsl_state_texture_coordinate_mode "glsl_state_texture_coordinate_mode"
- \ref mdl_option_glsl_state_texture_coordinate_name "glsl_state_texture_coordinate_name"
- \ref mdl_option_glsl_state_texture_tangent_u_mode  "glsl_state_texture_tangent_u_mode"
- \ref mdl_option_glsl_state_texture_tangent_u_name  "glsl_state_texture_tangent_u_name"
- \ref mdl_option_glsl_state_texture_tangent_v_mode  "glsl_state_texture_tangent_v_mode"
- \ref mdl_option_glsl_state_texture_tangent_v_name  "glsl_state_texture_tangent_v_name"
- \ref mdl_option_glsl_state_texture_space_max_mode  "glsl_state_texture_space_max_mode"
- \ref mdl_option_glsl_state_texture_space_max_name  "glsl_state_texture_space_max_name"
- \ref mdl_option_glsl_state_transform_o2w_mode      "glsl_state_transform_o2w_mode"
- \ref mdl_option_glsl_state_transform_o2w_name      "glsl_state_transform_o2w_name"
- \ref mdl_option_glsl_state_transform_w2o_mode      "glsl_state_transform_w2o_mode"
- \ref mdl_option_glsl_state_transform_w2o_name      "glsl_state_transform_w2o_name"
- \ref mdl_option_glsl_uniform_ssbo_name             "glsl_uniform_ssbo_name"
- \ref mdl_option_glsl_version                       "glsl_version"


\section mdl_cg_glsl_options Specific MDL GLSL code generator options

\anchor mdl_option_glsl_enabled_extensions
  <b>glsl_enabled_extensions:</b> A comma separated list of enabled GLSL extensions.
  Possible values: see \see supported_glsl_extensions
  Default: ""

\anchor mdl_option_glsl_include_uniform_state
  <b>glsl_include_uniform_state:</b> Include uniform MDL state into core state.
  Possible values: "true", "false"
  Default: "false"

\anchor mdl_option_glsl_lambda_enforce_vec3_return
  <b>glsl_lambda_enforce_vec3_return:</b> Enforce that lambda functions return at least a vec3.
  Possible values: "true", "false"
  Default: "true"

\anchor mdl_option_glsl_max_const_data
<b>glsl_max_const_data:</b> Specifies the maximum allowed amount in bytes of constant data
                            for a generated shader by the GLSL backend. If bigger data are
                            necessary, the backend will move it to uniform inputs.
  Default: "1024"

\anchor mdl_option_glsl_place_uniforms_into_ssbo
  <b>glsl_place_uniforms_into_ssbo:</b> If true and the GL_ARB_shader_storage_buffer_object
  extension is enabled, the GLSL backend will place all uniforms into one SSBO.
  Possible values: "true", "false"
  Default: "false"

\anchor mdl_option_glsl_profile
  <b>glsl_profile:</b> Specifies the GLSL target language profile.
  Possible values: "core", "compatibility", "es"
  Default: "core"

\anchor mdl_option_glsl_required_extensions
  <b>glsl_enabled_extensions:</b> A comma separated list of required GLSL extensions.
  Possible values: see \see supported_glsl_extensions
  Default: ""

\anchor mdl_option_glsl_state_animation_time_mode
  <b>glsl_state_animation_time_mode:</b> Specify the implementation mode of state::animation_time().
  Possible values: see \see supported_state_modes
  Default: "zero"

  \anchor mdl_option_glsl_state_animation_time_name
  <b>glsl_state_animation_time_name:</b> Specify the entity representing state::animation_time().
  Possible values: any valid GLSL identifier
  Default: "animation_time"

\anchor mdl_option_glsl_state_geometry_normal_mode
  <b>glsl_state_geometry_normal_mode:</b> Specify the implementation mode of
                                         state::geometry_normal().
  Possible values: see \see supported_state_modes
  Default: "field"

\anchor mdl_option_glsl_state_geometry_normal_name
  <b>glsl_state_geometry_normal_name:</b> Specify the entity representing
                                         state::geometry_normal().
  Possible values: any valid GLSL identifier
  Default: "geometry_normal"

\anchor mdl_option_glsl_state_geometry_tangent_u_mode
  <b>glsl_state_geometry_tangent_u_mode:</b> Specify the implementation mode of
  state::geometry_tangent_u().
  Possible values: see \see supported_state_modes
  Default: "zero"

\anchor mdl_option_glsl_state_geometry_tangent_u_name
  <b>glsl_state_geometry_tangent_u_name:</b> Specify the entity representing
  state::geometry_tangent_u().
  Possible values: any valid GLSL identifier
  Default: "geometry_tangent_u"

\anchor mdl_option_glsl_state_geometry_tangent_v_mode
  <b>glsl_state_geometry_tangent_v_mode:</b> Specify the implementation mode of
  state::geometry_tangent_v().
  Possible values: see \see supported_state_modes
  Default: "zero"

\anchor mdl_option_glsl_state_geometry_tangent_v_name
  <b>glsl_state_geometry_tangent_v_name:</b> Specify the entity representing
  state::geometry_tangent_v().
  Possible values: any valid GLSL identifier
  Default: "geometry_tangent_v"

\anchor mdl_option_glsl_state_motion_mode
  <b>glsl_state_motion_mode:</b> Specify the implementation mode of state::motion().
  Possible values: see \see supported_state_modes
  Default: "zero"

\anchor mdl_option_glsl_state_motion_name
  <b>glsl_state_motion_name:</b> Specify the entity representing state::motion().
  Possible values: any valid GLSL identifier
  Default: "motion"

\anchor mdl_option_glsl_state_normal_mode
  <b>glsl_state_normal_mode:</b> Specify the implementation mode of state::normal().
  Possible values: see \see supported_state_modes
  Default: "field"

\anchor mdl_option_glsl_state_normal_name
  <b>glsl_state_normal_name:</b> Specify the entity representing state::normal().
  Possible values: any valid GLSL identifier
  Default: "normal"

\anchor mdl_option_glsl_state_object_id_mode
  <b>glsl_state_normal_mode:</b> Specify the implementation mode of state::object_id().
  Possible values: see \see supported_state_modes
  Default: "zero"

\anchor mdl_option_glsl_state_object_id_name
  <b>glsl_state_normal_name:</b> Specify the entity representing state::object_id().
  Possible values: any valid GLSL identifier
  Default: "object_id"

\anchor mdl_option_glsl_state_position_mode
  <b>glsl_state_position_mode:</b> Specify the implementation mode of state::position().
  Possible values: see \see supported_state_modes
  Default: "field"

\anchor mdl_option_glsl_state_position_name
  <b>glsl_state_position_name:</b> Specify the implementation mode of state::position().
  Possible values: any valid GLSL identifier
  Default: "position"

\anchor mdl_option_glsl_state_texture_coordinate_mode
  <b>glsl_state_texture_coordinate_mode:</b> Specify the implementation mode of
  state::texture_coordinate().
  Possible values: see \see supported_state_modes
  Default: "zero"

\anchor mdl_option_glsl_state_texture_coordinate_name
  <b>glsl_state_texture_coordinate_name:</b> Specify the entity representing
  state::texture_coordinate().
  Possible values: any valid GLSL identifier
  Default: "texture_coordinate"

\anchor mdl_option_glsl_state_texture_tangent_u_mode
  <b>glsl_state_texture_tangent_u_mode:</b> Specify the implementation mode of
  state::texture_tangent_u().
  Possible values: see \see supported_state_modes
  Default: "zero"

\anchor mdl_option_glsl_state_texture_tangent_u_name
  <b>glsl_state_texture_tangent_u_name:</b> Specify the entity representing
  state::texture_tangent_u().
  Possible values: any valid GLSL identifier
  Default: "texture_tangent_u"

\anchor mdl_option_glsl_state_texture_tangent_v_mode
  <b>glsl_state_texture_tangent_v_mode:</b> Specify the implementation mode of
  state::texture_tangent_v().
  Possible values: see \see supported_state_modes
  Default: "zero"

\anchor mdl_option_glsl_state_texture_tangent_v_name
  <b>glsl_state_texture_tangent_v_name:</b> Specify the entity representing
  state::texture_tangent_v().
  Possible values: any valid GLSL identifier
  Default: "texture_tangent_v"

\anchor mdl_option_glsl_state_texture_space_max_mode
  <b>glsl_state_texture_space_max_mode:</b> Specify the implementation mode of
                                           state::texture_space_max().
  Possible values: see \see supported_state_modes
  Default: "zero"

\anchor mdl_option_glsl_state_texture_space_max_name
  <b>glsl_state_texture_space_max_name:</b> Specify the entity representing
                                           state::texture_space_max().
  Possible values: any valid GLSL identifier
  Default: "texture_space_max"

\anchor mdl_option_glsl_state_transform_o2w_mode
  <b>glsl_state_transform_o2w_mode:</b> Specify the implementation mode of
  the object-to-world transform matrix, used to implement uniform state::transform*() calls.
  Possible values: see \see supported_state_modes
  Default: "zero"

\anchor mdl_option_glsl_state_transform_o2w_name
  <b>glsl_state_transform_o2w_name:</b> Specify the entity representing
  the object-to-world transform matrix, used to implement uniform state::transform*() calls.
  Possible values: any valid GLSL identifier
  Default: "o2w_transform"

\anchor mdl_option_glsl_state_transform_w2o_mode
  <b>glsl_state_transform_o2w_mode:</b> Specify the implementation mode of
  the world-to-object transform matrix, used to implement uniform state::transform*() calls.
  Possible values: see \see supported_state_modes
  Default: "zero"

\anchor mdl_option_glsl_state_transform_w2o_name
  <b>glsl_state_transform_o2w_name:</b> Specify the entity representing
  the world-to-object transform matrix, used to implement uniform state::transform*() calls.
  Possible values: any valid GLSL identifier
  Default: "o2w_transform"

\anchor mdl_option_glsl_uniform_ssbo_name
  <b>glsl_version:</b> Specifies the name for the SSBO buffer used by the GLSL backend if this
  feature is enabled.
  Possible values: any valid GLSL identifier
  Default: ""

\anchor mdl_option_glsl_version
  <b>glsl_version:</b> Specifies the GLSL target language version.
  Possible values: "1.00", "1.10", "1.20", "1.30", "1.40", "1.50", "3.00", "3.10", "3.30",
  "4.00", "4.10", "4.20", "4.30", "4.40", "4.50"
  Default: "3.30"

\section supported_state_modes Possible modes to access the MDL state
- \c "field": access a field of a passed state struct, aka state.\<entity_name\>
- \c "arg":   access an argument of the generated shader, aka \<entity_name\>
- \c "func":  call a wrapper function, aka \<entity_name\>(...)
- \c "zero":  always zero for scalar/vector values, identity for matrices

\section supported_glsl_extensions Supported GLSL extensions
...
The following extensions are partly supported by the GLSL backend:
- \c "GL_OES_texture_3D"
