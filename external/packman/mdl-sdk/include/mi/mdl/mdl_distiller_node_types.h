...
enum Mdl_node_type_enum {
    ...
    // ::nvidia::df:: Module
    //
    nvidia_df_ashikhmin_shirley_glossy_bsdf,
    nvidia_df = nvidia_df_ashikhmin_shirley_glossy_bsdf,
    nvidia_df_ward_geisler_moroder_glossy_bsdf,
    nvidia_df_microfacet_beckmann_smith_bsdf,
    nvidia_df_microfacet_ggx_smith_bsdf,
    nvidia_df_microfacet_beckmann_vcavities_bsdf,
    nvidia_df_microfacet_ggx_vcavities_bsdf,
    nvidia_df_microfacet_phong_vcavities_bsdf,
    nvidia_df_simple_glossy_bsdf,
    nvidia_df_simple_glossy_bsdf_legacy,
    // nvidia_df_legacy_mcp_glossy_bsdf // ignored, only needed in MetaSL material for one customer
    last_nvidia_df = nvidia_df_simple_glossy_bsdf_legacy
#endif
};
