...
public:
    ...
    /// The name of the options that enables replacement of df::simple_glossy_bsdf() by
    /// nvidia::df::simple_glossy_bsdf_legacy() for pre MDL 1.3.
    #define MDL_OPTION_USE_SIMPLE_GLOSSY_BSDF_LEGACY "use_simple_glossy_bsdf_legacy"
#endif
